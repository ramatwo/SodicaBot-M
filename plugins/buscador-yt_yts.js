...
let textoInfo = `${lenguajeGB['smsAvisoIIG']()}𝙋𝙐𝙀𝘿𝙀𝙎 𝘿𝙀𝙎𝘾𝘼𝙍𝙂𝘼𝙍 𝙀𝙇 𝙑𝙄𝘿𝙀𝙊 𝙌𝙐𝙀 𝙌𝙐𝙄𝙀𝙍𝘼𝙎 𝘿𝙀 𝙀𝙎𝙏𝘼 𝙁𝙊𝙍𝙈𝘼:
${usedPrefix}video link 
${usedPrefix}audio link

*𝙀𝙅𝙀𝙈𝙋𝙇𝙊:*
*${usedPrefix}video _link_*\n\n••••••••••••••••••••••••••••••••••••`.trim()  
...
handler.tags = ['tools']
handler.command = /^playlist|youtube|ytbuscar|yts(earch)?$/i
handler.exp = 70
handler.limit = 1
handler.level = 4
