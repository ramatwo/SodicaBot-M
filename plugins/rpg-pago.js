...
let fotilla =  "./media/menus/velocidad.bat"
let enlace = { contextInfo: { externalAdReply: {title: wm + ' 🐈', body: 'support group' , sourceUrl: grupos.getRandom(), thumbnail: await(await fetch(fotilla.getRandom())).buffer() }}}
