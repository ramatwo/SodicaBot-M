...
_2.Top Coinss_ *${usersmoney.indexOf(m.sender) + 1}* _de_ *${usersmoney.length}*
...
*│ ⛏️🐱 Minar Coinss » ${new Date - user.lastcoins < 600000 ? '❌' : '✅'}*
...
conn.sendFile(m.chat, imgr, 'SodicaBot.exe', aineh, fkontak, m)}
