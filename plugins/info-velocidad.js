...
let gata = "./media/menus/velocidad.bat"
...
`
await conn.sendFile(m.chat, gata, 'Ping.bat', caption, fkontak)
...
handler.command = /^(ping|speed|velocidad|rapidez|status|velocity)$/i
