let handler = async (m, { conn, text, usedPrefix, command}) => {
    ...
    await conn.reply(m.chat, lenguajeGB.smsPropban8(), null, { mentions: [user] }) 
    await conn.reply(m.chat, lenguajeGB.smsPropban9(), null, { mentions: [user] })     
    ...
    handler.command = /^privatebanuser|pvbanuser|pvban$/i
    handler.rowner = true
