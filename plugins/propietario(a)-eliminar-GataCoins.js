...
handler.tags = ['Coinss']
handler.command = ['eliminarCoinss', 'eliminargata', 'eliminarcoins', 'quitarCoinss', 'quitargata', 'quitarcoins', 'delCoinss', 'delgata', 'delcoins'] 
handler.group = true
handler.rowner = true
