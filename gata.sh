...
if wget -q https://github.com/ramardo/SodicaBot-M/raw/master/musicSH/"$random_mp3"; then
...
echo -e "\033[1;35m"
git clone https://github.com/ramardo/SodicaBot-M.git
...
menu_ayuda() {
    #printf "${v1}[${b}++${v1}]${v} SodicaBot-MD${b}: "
	read opcion
	case $opcion in
            01|1)
...
echo -e "\033[01;32m\033[01mIniciando SodicaBot!!\n\033[0m"
npm start
