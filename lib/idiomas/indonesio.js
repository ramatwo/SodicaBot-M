...
const smsLista1 = () => { return `🌟 INFORMASI SodicaBot 🌟`}
...
const smsLista7 = () => { return `🐈 PASANG SodicaBot 🐈`}
...
const smsModP2 = () => { return `Aktifkan fungsi agar semua orang dapat menggunakan SodicaBot`}
const smsModAd1 = () => { return `🛂 MODE ADMIN`}
const smsModAd2 = () => { return `Hanya Admin yang dapat menggunakan SodicaBot di Grup`}
...
const smsContacto4 = () => { return 'Kontak Resmi SodicaBot 🐈'}
