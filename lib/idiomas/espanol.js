...
const smsAvisoMG = () => { return `╰⊱❗️⊱ *MAL* ⊱❗️⊱╮\n\n` }
const smsAvisoEEG = () => { return `╰⊱📩⊱ *REPORTE* ⊱📩⊱╮\n\n` }
const smsAvisoEG = () => { return `╰⊱💚⊱ *HECHO* ⊱💚⊱╮\n\n` }

//PARÁMETROS EN COMANDOS
<<<<<<< HEAD
const smsRowner = () => { return `\`\`\`Este comando sólo el creador del bot lo puede usar.\`\`\`` }//NUMERO DE BOT
...
const smsGroup = () => { return `\`\`\`Este comando sólo se puede utilizar en grupor.\`\`\`` }//PARA GRUPOS
...
const smsUnreg = () => { return `\`\`\`Necesitas estar registrado para usar este comando. Pon #registrar\`\`\`` }//VERIFICAR
...
const smsRestrict = () => { return `\`\`\`¡¡ESTE COMANDO ESTÁ RESTRINGIDO POR MI CREADOR(A)!!\`\`\`` }//RESTRINGIR COMANDO
...
const smsEnlaceWat = () => { return `${lenguajeGB['smsAvisoAG']()}Enlace detectado. Removiendo vagabundo...`}

//_antilink2.js
const smsEnlaceWatt = () => { return `${lenguajeGB['smsAvisoAG']()}Enlace detectado. Removiendo vagabundo...`}
