...
const smsPremium = () => { return `\`\`\`⫹⫺ ➭⛔ ∫ Este comando sólo está disponible para usuarios premium.\`\`\`` }//USUARIOS PREMIUM
...
const smsNoSpam6 = () => { return  (mention) => `*${mention} ESTA PROHIBIDO HACER SPAM DE MENSAJES!!*` }
