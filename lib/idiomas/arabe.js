...
const smsLista1 = () => { return `🌟 معلومات SodicaBot 🌟`}
...
const smsLista7 = () => { return `🐈 تثبيت SodicaBot 🐈`}
...
//_allantilink.js
const smsTextoYT = () => { return '😻 ممتاز SodicaBot-MD - WhatsApp '}
...
const smsModP2 = () => { return `تمكين الوظيفة حتى يتمكن الجميع من استخدام SodicaBot`}
const smsModAd1 = () => { return `🛂 وضع المشرف`}
const smsModAd2 = () => { return `سيتمكن المسؤولون فقط من استخدام SodicaBot في المجموعات`}
...
const smsJBInfo2 = () => { return `💖 *الوظيفة مستقرة ، إذا واجهت أي إزعاج ، فاتصل بالبريد: centerSodicaBot@gmail.com*\n💝 *يمكنك تقديم تبرع طوعي عن طريق PayPal: ${global.paypal}*\n\n*شكرا جزيلا على الدعم ${global.packname}*`}
...
const smsContacto4 = () => { return 'جهة اتصال SodicaBot الرسمية 🐈'}
